...
After finding all the internal forces, I was able to pick out the two forces holding the maximum tension forces and maximum compression force that would be used for calculating the minimum cross sectional area of the joints.  Since these elements will hold the strongest forces, finding the necessary cross sectional area will allow me to guarantee that it will be strong enough for the remaining elements as well.
